            ...
            Container(
              ...
              child: Padding(
                ...
                child: TextButton(
                  ...
                  onPressed: () {
                    customLaunch(
                        'mailto: info@Product_get_from_api_in_fluttercircle.com?subject=&body=');
                  },
                  child: Text(
                    "info@Product_get_from_api_in_fluttercircle.com",
                    style: TextStyle(
                      fontSize: 15,
                      letterSpacing: 2.2,
                      color: Colors.pink[700],
          ...
          child: Column(
            children: <Widget>[
              Container(
                ...
                child: Text(
                  "Product_get_from_api_in_flutter Circle Operating Hours",
                  style: TextStyle(
                    fontSize: 16,
                    letterSpacing: 2.5,
                    color: Colors.pink[700],
